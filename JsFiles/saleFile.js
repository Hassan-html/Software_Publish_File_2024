    ...
    $.ajax({
        ...
        success: function (result) {
            ...
            $.each(result, function (key, item) {
                ...
                html += '<td class="aa nextr" contenteditable="True" style="font-weight:bold">' + item.SaleRate + '</td>';
...
function CancelInvoice() {
    ...
    $.ajax({
        type: "POST",
        url: "/Sale/DeletePreviousInvoice",
        data: JSON.stringify(empObj),
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        success: function (result) {
